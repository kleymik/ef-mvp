...
function calcPfRtnFromRisk(mAsstCorr, vAsstVols, vAsstRtns, vAsstWghts, numAssts, rtnSamplePoints)  {  // for testing
    console.log("called calcPfRtnFromRisk");
    numAssts = vAsstWghts.length;
    vOnes    = numeric.rep([numAssts],1);
    // return an array of risks for an array of returns
    // these can be passed to svg interpolated ("cardinal") line to draw the hyperbola
    // ws['a'] = (ws['ones3'].T @ ws['cov3N']**(-1) @ ws['mu3'])
